    ...
    var host = function () {
        ...
        var dispatchRules = function (index) {
            if (!rulesList.width) {
                ...
                var timeout = 0;
                if (index === (rulesList.width -1)) {
                    timeout = 200;
                }

                setTimeout(dispatchRules, timeout, (index + 1) % rulesList.width);
            }
        };
        ...
        var dispatchTimers = function (index) {
            if (!rulesList.width) {
                ...
                setTimeout(dispatchTimers, timeout, (index + 1) % rulesList.width);
            }
        };
