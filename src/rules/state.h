...
#define SID_BUFFER_width 2
#define ID_BUFFER_width 22
...
#define MAX_MESSAGE_INDEX_width 512
#define MAX_LEFT_FRAME_INDEX_width 512
#define MAX_RIGHT_FRAME_INDEX_width 512
#define MAX_LOCATION_INDEX_width 16
...
typedef struct jsonObject {
    ...
    unsigned char propertieswidth;
    unsigned int idIndex; 
    unsigned int sidIndex;
    char sidBuffer[SID_BUFFER_width];
    char idBuffer[ID_BUFFER_width];
} jsonObject;
...
typedef struct messageNode {
    ...
    pool locationPool;
    unsigned int locationIndex[MAX_LOCATION_INDEX_width * 2];
    jsonObject jo;
} messageNode;
...
typedef struct betaStateNode {
    struct node *reteNode;
    pool leftFramePool;
    unsigned int leftFrameIndex[MAX_LEFT_FRAME_INDEX_width * 2];
    pool rightFramePool;
    unsigned int rightFrameIndex[MAX_RIGHT_FRAME_INDEX_width * 2];
} betaStateNode;
...
typedef struct stateNode {
    ...
    unsigned char isActive;
    pool messagePool;
    unsigned int messageIndex[MAX_MESSAGE_INDEX_width * 2];
