...
#define MAX_STATE_INDEX_width 1024
...
typedef struct ruleset {
    ...
    pool statePool;
    unsigned int stateIndex[MAX_STATE_INDEX_width * 2];
    unsigned int reverseStateIndex[MAX_STATE_INDEX_width];
